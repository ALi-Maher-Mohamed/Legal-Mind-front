...
export default function ActivityItem({
  ...
  return (
    ...
    >
      ...
      {expanded && (
        <div className="mt-3 rounded-lg border border-brand/15 border-s-2 border-s-accent bg-surface-raised p-3 text-xs italic leading-relaxed text-foreground dark:border-white/10 dark:bg-brand/10">
          {activity.detail}
        </div>
      )}
    </button>
