  ...
  return (
    <div className={`${dashPanel} flex h-full flex-col justify-between transition hover:border-brand`}>
      <div className="flex-1 p-4 sm:p-5">
        <div className="relative mb-3 flex h-28 flex-col justify-between overflow-hidden rounded-xl border border-brand/15 bg-[#f0f4ff] p-3 dark:border-white/10 dark:bg-white/5 sm:mb-4 sm:h-36 sm:p-4 md:h-40">
      ...
      <div className="border-t border-brand/10 bg-[#f8faff]/50 p-4 dark:border-white/10 dark:bg-white/[0.03] sm:p-5">
        <button
          type="button"
