  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center ${isRtl ? 'lg:direction-rtl' : 'lg:direction-ltr'}`}>
          
          <div className={`lg:col-span-6 flex flex-col items-center lg:items-start ${isRtl ? 'lg:text-right' : 'lg:text-left'} text-center gap-6`}>
            <motion.div
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-100 leading-tight w-full"
            >
              {isRtl ? (
                <>
            ...
            <motion.p
              ...
              className={`text-sm sm:text-base text-slate-300 leading-relaxed max-w-xl ${isRtl ? 'lg:text-right' : 'lg:text-left'} text-center`}
            >
              {t.hero.description}
            </motion.p>
              ...
              >
                ...
                >
                  <Card
                    ...
                    className="p-4 flex flex-row items-center gap-4 border border-slate-800 bg-slate-900 shadow-sm group transition-all w-full text-start"
                  >
                    {/* تعديل حاوية الأيقونة لتكون مربع صغير مرن بدلاً من شريط ممتد */}
                    <div className="flex items-center justify-center h-11 w-11 bg-slate-800 rounded-xl text-slate-100 group-hover:scale-110 group-hover:bg-slate-700 transition-all duration-300 shrink-0">
                      {feat.icon}
                    </div>
                    {/* النص بجانب المربع تماماً */}
