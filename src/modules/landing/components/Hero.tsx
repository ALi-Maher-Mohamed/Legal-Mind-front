    ...
    <section className="relative overflow-hidden bg-background pt-28 pb-16 md:pt-36 md:pb-24">
      ...
      <div className="lm-container relative z-10">
        <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between gap-10 lg:gap-8">
          {/* Visual column — start side in LTR / end in RTL via flex order */}
          <motion.div
          ...
          >
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {chips.map((chip, i) => {
                ...
                return (
                  <div
                    key={chip.title}
                    className="glass-panel flex items-center justify-end gap-2 rounded-lg px-3 py-3.5 shadow-sm"
                    style={{ animationDelay: `${i * 80}ms` }}
                  >
                    <span className="text-[11px] sm:text-xs font-bold tracking-wide text-foreground">{chip.title}</span>
            ...
            <div className="relative h-48 sm:h-64 w-full overflow-hidden rounded-2xl border border-outline/40 shadow-xl">
              <Image
          ...
          <motion.div
            ...
            className="w-full lg:max-w-[672px] flex flex-col gap-4 items-center lg:items-stretch text-center lg:text-start"
          >
