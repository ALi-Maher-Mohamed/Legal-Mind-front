...
export default function Hero() {
  ...
  const floatingFeatures = [
    {
      title: t.hero.features.analyzeDocs,
      icon: <Shield className="h-5 w-5 text-blue-400" />,
      delay: 0,
      hoverGlow: "rgba(59, 130, 246, 0.2)",
    },
    {
      title: t.hero.features.generateContracts,
      icon: <FileText className="h-5 w-5 text-purple-400" />,
      delay: 0.2,
      hoverGlow: "rgba(139, 92, 246, 0.2)",
    },
    {
      title: t.hero.features.legalConsultation,
      icon: <Cpu className="h-5 w-5 text-emerald-400" />,
      delay: 0.4,
      hoverGlow: "rgba(16, 185, 129, 0.2)",
    },
    {
      title: t.hero.features.govGuide,
      icon: <Search className="h-5 w-5 text-accent-gold" />,
      delay: 0.1,
      hoverGlow: "rgba(246, 196, 83, 0.2)",
    },
    {
      title: t.hero.features.explainTerms,
      icon: <HelpCircle className="h-5 w-5 text-pink-400" />,
      delay: 0.3,
      hoverGlow: "rgba(244, 63, 94, 0.2)",
    },
    {
      title: t.hero.features.caseTracking,
