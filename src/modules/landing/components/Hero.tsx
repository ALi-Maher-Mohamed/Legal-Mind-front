...
export default function Hero() {
  ...
  const floatingFeatures = [
    ...
    { title: t.hero.features.govGuide, icon: <Search className="h-5 w-5 text-[#F6C453]" />, delay: 0.1, hoverGlow: "rgba(246, 196, 83, 0.2)" },
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-[#090909]">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] rounded-full bg-blue-600/10 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[350px] sm:w-[500px] h-[350px] sm:h-[500px] rounded-full bg-purple-600/10 blur-[100px] pointer-events-none" />
