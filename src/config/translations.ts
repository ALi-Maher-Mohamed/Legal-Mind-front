...
export const translations = {
  en: {
    ...
    auth: {
      ...
      forgotSubtitle: "Enter your work email and we will send a verification code.",
      ...
      resetSubtitle: "Choose a strong password for your LegalMind workspace.",
      newPasswordPlaceholder: "New password...",
      confirmPasswordPlaceholder: "Confirm new password...",
      resetBtn: "Update password",
      resetSuccess: "Password updated. You can sign in now.",
      backToLogin: "Back to sign in",
      otpInvalid: "Invalid or expired code. Try 123456 in demo.",
